...
% --- change object counting between Arabic and Roman ---
%\renewcommand{\thetable}{\Roman{table}} % required for conference or other occasions
...
% --- change autoref displaying text (based on IEEE template) ---
% https://tex.stackexchange.com/questions/142687/customize-of-autoref
\renewcommand{\figureautorefname}{Fig.} % the "." is to represent the abbreviation of Figure
%\renewcommand{\tableautorefname}{Tab.} % default setting is fine
\renewcommand{\equationautorefname}{} % except at the begining of the sentence "Equation" needs to be added manually.
%\renewcommand{\algorithmautorefname}{Alg.} % default setting is fine
\renewcommand{\sectionautorefname}{Chapter}
\renewcommand{\subsectionautorefname}{Section}
\renewcommand{\subsubsectionautorefname}{Subsection}
\renewcommand{\paragraphautorefname}{Subsubsection}
...
%\crefname{table}{Tab.}{Tab.} % default setting is fine
\crefname{equation}{}{}
%\crefname{algorithm}{Alg.}{Alg.} % default setting is fine
\crefname{section}{Chapter}{Chapter}
\crefname{subsection}{Section}{Section}
\crefname{subsubsection}{Subsection}{Subsection}
\crefname{paragraph}{Subsubsection}{Subsubsection}
...
% \input{} command is used to insert different sections into one document
\begin{document}
\input{cover.tex}
